...
class User(db.Model):
    ...
    posts = db.relationship('BlogPost', backref='user', cascade='all, delete-orphan')
...
class BlogPost(db.Model):
    ...
    user = db.relationship('User', backref=db.backref('posts', lazy=True))  # Relationship to User
